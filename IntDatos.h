...
/*Precondición: barcos v_barcos[] es un vector que almacena datos con estructura barcos e int n_barcos el numero total de tipos de barcos. int *valor
                sera el puntero donde guardaremos el tamaño del tablero*/
/*Postcondición: Establecer el tamaño del tablero y asegurarse de que este no pueda ser más pequeño al tamaño teórico máximo que ocupanrán
                 los barcos*/
